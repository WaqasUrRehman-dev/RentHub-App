...
const ForgotPasswordMail = async (name, email, link, message) => {
    ...
    var emailDetails = {
        body: {
            ...
            outro: 'If you did not request a password reset, please ignore this email. This link is valid for the next 5 minutes.',
            action: {
